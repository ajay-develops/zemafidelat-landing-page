export const testimonials = [
  {
    id: 1,
    text: "Zema Fidelat has made learning a new language feel effortless. The step-by-step lessons keep me coming back every day.",
    name: "Alice Johnson",
  ...
  {
    id: 5,
    text: "The letter tracing game is brilliant for learning a new script. My handwriting has improved dramatically.",
    name: "Ethan Ford",
  ...
  {
    id: 6,
    text: "I love that I can try the app as a guest before signing up. No pressure, just pure learning fun.",
    name: "Fiona Grant",
    role: "HR Manager",
    image:
  ...
  {
    id: 7,
    text: "Earning XP and unlocking achievement badges makes every lesson feel rewarding. Highly addictive in the best way.",
    name: "George Harris",
  ...
  {
    id: 9,
    text: "Reminder notifications keep me on track with my daily learning goals. I never forget to practice anymore.",
    name: "Ian Johnson",
  ...
  {
    id: 10,
    text: "Fidel Make is such a clever game. Matching images to words has helped me build vocabulary faster than anything else.",
    name: "Julia Kim",
    role: "Researcher",
    image:
  ...
  {
    id: 11,
    text: "The dashboard gives me a clear picture of my progress. Seeing my streak and XP grow is incredibly motivating.",
    name: "Kevin Lee",
  ...
  {
    id: 13,
    text: "The lessons are perfectly paced. Flashcards, tracing, and word games in one flow — it never gets boring.",
    name: "Michael Nelson",
    role: "Entrepreneur",
    image:
  ...
  {
    id: 14,
    text: "Managing multiple profiles means my whole family learns on one account. Each person tracks their own progress.",
    name: "Natalie Owens",
  ...
  {
    id: 16,
    text: "The word selection games are addictive. I find myself playing just one more round every time I open the app.",
    name: "Patricia Quinn",
  ...
  {
    id: 17,
    text: "Achievement badges give me something to work toward beyond just finishing lessons. Love the gamification.",
    name: "Quincy Roberts",
  ...
  {
    id: 18,
    text: "Daily goals and streaks have turned language learning into a habit I actually enjoy keeping.",
    name: "Rachel Stevens",
    role: "Life Coach",
    image:
  ...
  {
    id: 19,
    text: "The crossword puzzles are a genius way to reinforce vocabulary. I look forward to them every single day.",
  ...
  {
    id: 20,
    text: "Guest mode let me explore the full app before creating an account. A thoughtful touch for new learners.",
    name: "Tina Upton",
  ...
  {
    id: 21,
    text: "Progress tracking shows exactly where I am in each lesson. I always know what to study next.",
    name: "Ulysses Vaughn",
  ...
  {
    id: 23,
    text: "I started as a complete beginner and the step-by-step lessons made everything click. Highly recommend!",
    name: "William Xavier",
  ...
  {
    id: 24,
    text: "The turtle mascot and colorful design make learning feel playful. My students absolutely love this app.",
    name: "Xena Yates",
    role: "Wellness Coach",
    image:
